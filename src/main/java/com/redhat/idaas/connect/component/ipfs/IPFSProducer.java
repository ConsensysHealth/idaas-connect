 ...
 */
package com.redhat.idaas.connect.component.ipfs;
...
import com.redhat.idaas.connect.component.ipfs.IPFSComponent;
import com.redhat.idaas.connect.component.ipfs.IPFSConfiguration.IPFSCommand;
import com.redhat.idaas.connect.component.ipfs.IPFSEndpoint;
...
public class IPFSProducer extends DefaultProducer {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        if (IPFSCommand.version == cmd) {
            ...
            if ( path == null ) {
                byte[] obj = exchange.getMessage().getBody().toString().getBytes();
                cids = ipfsAdd(obj);
            } else {
                cids = ipfsAdd(path);
            }
    ...
    public List<String> ipfsAdd(byte[] obj) throws IOException {
        Multihash cid = ipfs().addSingle(obj);
        return Arrays.asList(new String[]{cid.toBase58()});
    }
